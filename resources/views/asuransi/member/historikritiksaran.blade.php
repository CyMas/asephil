                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> History <a href="/asuransi/member/histori/kritik">Kritik</a> / <a href="/asuransi/member/histori/saran">Saran</a>
                            </li>
                        </ol>
                    </div>
                </div>
                                ...
                                <?php $i = 1; ?>
                                    @foreach($data as $post)
                                        <tr>
                                            ...
                                            <td>{{ $post->email }}</td>                       
                                            <td>{{ $post->pilihan }}</td>
                                            <td><a href="{{ url('asuransi/member/histori/detail/'.$post->id) }}">Detail</a></td>                       
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
