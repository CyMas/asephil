            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            <form action="{{ url('asuransi/member/setoran/save') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                ...
                                <tr>
                                    ...
                                    <td><div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" name="jml_setoran" id="jml_setoran" value="15000" readonly autocomplete="off">
