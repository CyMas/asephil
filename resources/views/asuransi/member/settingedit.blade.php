            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Setting Profile
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            <form action="{{ url('asuransi/member/setting/update') }}" method="POST">
                            <table class="table hovered" style="width: 100%">
                                ...
                                <!-- <tr>
                                    ...
                                    <td><div class="input-control text full-size">
                                                <input class="form-control" type="text" value="{{ $data->password }}" name="password" autocomplete="off">
                                            </div></td>
                                </tr>
                                <tr>
                                    <td>Password Confirmation</td><td>:</td>
                                    <td><div class="input-control text full-size">
                                                <input class="form-control" type="text" value="{{ $data->password }}" name="password_confirmation" autocomplete="off">
                                            </div></td>
                                </tr> -->
                                <tr>
                            ...
                            <a href="/asuransi/member/setting"><div class="btn btn-default" onclick="return confirm('Batal ?')">Batal</div></a>
                            </form>   
                            <br>      
