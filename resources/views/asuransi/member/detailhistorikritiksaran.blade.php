                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-table"></i>  <a href="/asuransi/member/histori/kritik-saran">History Kritik / Saran</a>
                            </li>
                            <li class="active">
                ...
                <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                <tr>
                                    <td>Nama</td><td><strong>:</strong></td>
                                    <td>{{ $data->nama }}</td>
                                </tr>
                                <tr>
                                    <td>Email</td><td><strong>:</strong></td>
                                    <td>{{ $data->email }}</td>
                                </tr>
                                <tr>
                                    <td>Jenis</td><td><strong>:</strong></td>
                                    <td>{{ $data->pilihan }}</td>
                                </tr>
                                <tr>
                                    <td>Isi</td><td><strong>:</strong></td>
                                    <td>{{ $data->isi }}</td>
                                </tr>
                            </table>
                            <a href="{{ url('/asuransi/member/histori/detail/delete/'.$data->id) }}" onclick="return confirm('Yakin Hapus ?')"><div class="btn btn-default">Hapus</div></a>
                            <a href="{{ url('asuransi/member/histori/kritik-saran') }}"><div class="btn btn-default">Batal</div></a><br><br>
                        </div>
                </div>
                </div>
            <!-- /.container-fluid -->
