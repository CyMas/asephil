            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-6">
                        ...
                        <div class="table-responsive">
                            ...
                            <a href="{{ url('/asuransi/member/edit/'.$data->id) }}"><div class="btn btn-default">Edit</div></a>
                            <a href="{{ url('/asuransi/member/delete/'.$data->id) }}" onclick="return confirm('Yakin Hapus ?')"><div class="btn btn-default">Hapus</div></a><br><br>
