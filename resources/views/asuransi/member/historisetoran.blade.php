    ...
    @if(Auth::user()->type=="admin")
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                <div class="col-md-12">
                        <h2><a target="_blank" href="{{ url('asuransi/member/pemasukan/Report') }}"> Report Pemasukan </a></h2>
                                ...
                                <?php $i = 1; ?>
                                    @foreach($data as $post)
                                        <tr>
                                            ...
                                            <td>{{ "Rp.".number_format($post->jml_setoran,0,',','.').",-" }}</td>                     
                                            <td>{{ $post->created_at }}</td>                       
                                            <td>{{ $post->status }}</td>
                                            <td><a href="{{ url('asuransi/member/histori/setoran/edit/'.$post->id) }}">Edit</a></td>                     
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
