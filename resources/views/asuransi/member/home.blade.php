...
<body>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="media-heading"><strong>{{ Auth::user()->nama }}</strong>
                                        </h5>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    @endif<!-- 
                    <li>
                        <a href="/asuransi/member/forms"><i class="fa fa-fw fa-edit"></i> Forms</a>
                    </li>
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong></strong> With <a href="/asuransi" class="alert-link">D' Assurance</a> Just Rp.10.000,- / week
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            ...
                            @else(Auth::user()->type=="user")
                                ...
                                <div class="panel-footer">
                                    <span class="pull-left">List Anggota</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                ...
                                <div class="panel-footer">
                                    <span class="pull-left">List Admin</span>
    ...
    {!! HTML::script('member/js/plugins/morris/raphael.min.js') !!}
    {!! HTML::script('member/js/plugins/morris/morris.min.js') !!}
    {!! HTML::script('member/js/plugins/morris/morris-data.js') !!}
