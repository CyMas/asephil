            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <form action="{{ url('asuransi/member/histori/setoran/update') }}" method="POST">
                            <table class="table hovered" style="width: 100%">
                                ...
                                <tr>
                                    ...
                                    <td><div class="input-control text" data-role="datepicker">
                                            <input class="form-control" type="text" name="jml_setoran" value="{{ $data->jml_setoran }}" disabled>                                                    
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <a href="{{ url('asuransi/member/histori/setoran/') }}"><div class="btn btn-default">Batal</div></a>
                            </form>   
                            <br>
                        </div>
                </div>
