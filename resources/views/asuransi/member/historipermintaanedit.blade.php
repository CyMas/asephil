            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <form action="{{ url('asuransi/member/histori/permintaan/update') }}" method="POST">
                            <table class="table hovered" style="width: 100%">
                                ...
                                <tr>
                                    <td>Penerima Faedah</td><td>:</td>
                                    <td><div class="input-control text" data-role="datepicker">
                                            <input class="form-control" type="text" name="penerima_faedah" value="{{ $data->penerima_faedah }}" disabled>                                                    
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Jumlah Permintaan</td><td>:</td>
                                    <td><div class="input-control text" data-role="datepicker">
                                            <input class="form-control" type="text" name="jml_permintaan" value="{{ $data->jml_permintaan }}" disabled>                                                    
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <a href="{{ url('asuransi/member/histori/permintaan/') }}"><div class="btn btn-default">Batal</div></a>
                            </form>   
                            <br>
                        </div>
                </div>
